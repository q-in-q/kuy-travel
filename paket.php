            ...
            <div class="modal-body">
                <h6>Candi Prambanan</h6>
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <img src="image/pr2.jpg" class="img-fluid" />
                            </div>
                         </div>
                    </div>
...
<div class="container-fluid px-5 marketing">
    <h3 class="text-center my-5">PAKET WISATA JOGJA</h3>
    <div class="row">
        ...
        <!-- Modal -->
<div class="modal fade" id="merapi" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <h6>Museum Guunung Merapi</h6>
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="image/merapi1.jpg" class="img-fluid" /> 
                        </div>
                        <div class="col-lg-6">
                            <img src="image/merapi2.jpg" class="img-fluid" />
                        </div>
                     </div>
                </div>
                ...
                wawasan dan pemahaman tentang aspek ilmiah, maupun sosial-budaya dan lain-lain
                yang berkaitan dengan gunungapi dan sumber kebencanaan geologi lainnya.</p>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
        ...
        <!-- Modal MONJALI -->
        <div class="modal fade" id="monjali" role="dialog">
            <div class="modal-dialog">
    ...
    <!-- Modal Goa Pindul -->
    <div class="modal fade" id="gp" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                    <div class="col-lg-6">
                                        <img src="image/gp1.jpg" class="img-fluid" /> 
                                    </div>
                                    <div class="col-lg-6">
                                        <img src="image/gp2.jpg" class="img-fluid" />
                                    </div>
                                 </div>
                            </div>
    ...
    <div class="row">
        ...
        <!-- Modal SRI GETHUK -->
        <div class="modal fade" id="sri" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <h6>Air Terjun Sri Gethuk</h6>
                                <div class="row">
                                        <div class="col-lg-6">
                                            <img src="image/sr1.jpg" class="img-fluid" /> 
                                        </div>
                                        <div class="col-lg-6">
                                            <img src="image/sr2.jpg" class="img-fluid" />
                                        </div>
                                     </div>
                                </div>
        ...
        <!-- Modal TAMAN PINTAR -->
        <div class="modal fade" id="tp" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="image/tp1.jpg" class="img-fluid" />
                                        </div>
                                     </div>
                                </div>
    ...
    <!-- Modal indrayanti -->
    <div class="modal fade" id="in" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            <h6>Pantai Indrayanti</h6>
                            <div class="row">
                                    <div class="col-lg-6">
                                        <img src="image/in1.jpg" class="img-fluid" /> 
                                    </div>
                                    <div class="col-lg-6">
                                        <img src="image/in2.jpg" class="img-fluid" />
                                    </div>
                                 </div>
                            </div>
    ...
    <div class="row">
        ...
        <!-- Modal Breksi -->
        <div class="modal fade" id="br" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row">
                                        <div class="col-lg-6">
                                            <img src="image/tb1.jpg" class="img-fluid" /> 
                                        </div>
                                        <div class="col-lg-6">
                                            <img src="image/tb2.jpg" class="img-fluid" />
                                        </div>
                                     </div>
                                </div>
        ...
        <!-- Modal Kraton -->
        <div class="modal fade" id="kr" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <h6>Kraton Yogyakarta</h6>
                                <div class="row">
                                        <div class="col-lg-6">
                                            <img src="image/kr1.jpg" class="img-fluid" /> 
                                        </div>
                                        <div class="col-lg-6">
                                            <img src="image/kr2.jpg" class="img-fluid" />
                                        </div>
                                     </div>
                                </div>
